...
func (tree *layerTree) add(root common.Hash, parentRoot common.Hash, block uint64, period uint64, nodes *nodeSetWithOrigin, states *StateSetWithOrigin) error {
	...
	l := parent.update(root, parent.stateID()+1, block, period, nodes, states)
