...
func TestDiskLayerExternalInvalidationFullFlatten(t *testing.T) {
	...
	if err := snaps.Update(common.HexToHash("0x02"), common.HexToHash("0x01"), nil, accounts, nil, 0); err != nil {
...
func TestDiskLayerExternalInvalidationPartialFlatten(t *testing.T) {
	...
	if err := snaps.Update(common.HexToHash("0x03"), common.HexToHash("0x02"), nil, accounts, nil, 0); err != nil {
		t.Fatalf("failed to create a diff layer: %v", err)
	}
...
func TestDiffLayerExternalInvalidationPartialFlatten(t *testing.T) {
	...
	if err := snaps.Update(common.HexToHash("0x04"), common.HexToHash("0x03"), nil, accounts, nil, 0); err != nil {
		t.Fatalf("failed to create a diff layer: %v", err)
	}
...
func TestPostCapBasicDataAccess(t *testing.T) {
	...
	snaps.Update(common.HexToHash("0xa1"), common.HexToHash("0x01"), nil, setAccount("0xa1"), nil, 0)
	snaps.Update(common.HexToHash("0xa2"), common.HexToHash("0xa1"), nil, setAccount("0xa2"), nil, 0)
	snaps.Update(common.HexToHash("0xb2"), common.HexToHash("0xa1"), nil, setAccount("0xb2"), nil, 0)

	snaps.Update(common.HexToHash("0xa3"), common.HexToHash("0xa2"), nil, setAccount("0xa3"), nil, 0)
	snaps.Update(common.HexToHash("0xb3"), common.HexToHash("0xb2"), nil, setAccount("0xb3"), nil, 0)
...
func TestSnaphots(t *testing.T) {
	...
	for i := 0; i < 129; i++ {
		...
		snaps.Update(head, last, nil, setAccount(fmt.Sprintf("%d", i+2)), nil, 0)
		last = head
