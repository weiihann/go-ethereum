...
func TestAccountRange(t *testing.T) {
	...
	var (
		...
		sdb, _  = state.New(types.EmptyRootHash, statedb, nil, types.Period0)
	...
	sdb, _ = state.New(root, statedb, nil, types.Period0)
...
func TestEmptyAccountRange(t *testing.T) {
	...
	var (
		...
		st, _   = state.New(types.EmptyRootHash, statedb, nil, types.Period0)
	)
